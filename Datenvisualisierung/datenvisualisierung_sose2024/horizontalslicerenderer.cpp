...
void HorizontalSliceRenderer::initImageSliceGeometry()
{
    ...
    float unitSquareVertices[numVertices][3] = {{0, 0, static_cast<float>(zPosition)/15}, {1, 0, static_cast<float>(zPosition)/15}, {1, 1,static_cast<float>(zPosition)/15 }, {0, 1, static_cast<float>(zPosition)/15}};
